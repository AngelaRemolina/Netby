...
CREATE TABLE IF NOT EXISTS frame (
  ...
  icmp_data VARCHAR(200) NULL,
  tcp_segment VARCHAR(200) NULL,
  tcp_flags VARCHAR(200) NULL,
  tcp_data VARCHAR(200) NULL,
  http_data VARCHAR(200) NULL,
  https_data VARCHAR(200) NULL,
  ftp_data VARCHAR(200) NULL,
  ftps_data VARCHAR(200) NULL,
  smtp_data VARCHAR(200) NULL,
  pop3_data VARCHAR(200) NULL,
  udp_segment VARCHAR(200) NULL,
  dns_data VARCHAR(200) NULL,
  dhcp_data VARCHAR(200) NULL,
  other_ipv4_data VARCHAR(200) NULL,
  ethernet_data VARCHAR(200) NULL,
